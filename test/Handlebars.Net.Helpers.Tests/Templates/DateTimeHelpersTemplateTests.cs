...
public class DateTimeHelpersTemplateTests
{
    ...
    [InlineData("{{DateTime.Add \"2000-01-01\" 1 \"months\"}}", "2000-02-01")]
    [InlineData("{{DateTime.Add \"2000-01-01\" 1 \"days\"}}", "2000-01-02")]
    [InlineData("{{DateTime.Add \"2000-01-01 00:00:00\" 1 \"hours\"}}", "1:00:00")]
    [InlineData("{{DateTime.Add \"2000-01-01 00:00:00\" 1 \"minutes\"}}", "0:01:00")]
    [InlineData("{{DateTime.Add \"2000-01-01 00:00:00\" 1 \"seconds\"}}", "0:00:01")]
    public void Add_With_DatePart(string template, string expected)
    {
        // Arrange
        var action = _handlebarsContext.Compile(template);
    ...
    [InlineData("{{DateTime.Add \"01/01/2000\" 1 \"months\" \"dd/MM/yyyy\"}}", "2000-02-01")]
    [InlineData("{{DateTime.Add \"01/01/2000\" 1 \"days\" \"dd/MM/yyyy\"}}", "2000-01-02")]
    [InlineData("{{DateTime.Add \"01/01/2000 00:00:00\" 1 \"hours\" \"dd/MM/yyyy hh:mm:ss\"}}", "1:00:00")]
    [InlineData("{{DateTime.Add \"01/01/2000 00:00:00\" 1 \"minutes\" \"dd/MM/yyyy hh:mm:ss\"}}", "0:01:00")]
    [InlineData("{{DateTime.Add \"01/01/2000 00:00:00\" 1 \"seconds\" \"dd/MM/yyyy hh:mm:ss\"}}", "0:00:01")]
    public void Add_With_DatePart_Formatted(string template, string expected)
    {
        // Arrange
        var action = _handlebarsContext.Compile(template);
