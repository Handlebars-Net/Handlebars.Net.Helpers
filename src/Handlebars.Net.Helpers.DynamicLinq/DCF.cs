...
namespace System.Linq.Dynamic.Core
{
    ...
    public static class DynamicClassFactory2
    {
        ...
        /// </code>
        /// </example>
        public static Type CreateType(IList<DynamicPropertyWithValue> properties, bool createParameterCtor = true)
        {
            Guard.HasNoNulls(properties);
